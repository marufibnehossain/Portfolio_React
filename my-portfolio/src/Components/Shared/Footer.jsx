...
const Footer = () => {
  return (
    <div className='w-full py-5 px-7 bg-[#181818]'>
      <div className='max-w-[1400px] mx-auto md:flex md:justify-between lg:my-20 md:my-16 my-10'>
        {/* left */}
      ...
      <div className='max-w-[1400px] mx-auto md:flex justify-between border-t-2 border-[rgba(204,163,84,0.7)]'>
