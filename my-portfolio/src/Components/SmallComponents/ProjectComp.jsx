...
const ProjectComp = (props) => {
  ...
  return (
      <div style={{backgroundImage:`url(${props.image})`}} className='w-full h-[650px] bg-cover bg-center mxs:my-4 my-3 border-2 border-[#cca354] shadow-[0px_0px_15px_rgba(204,163,84,0.5)] md:px-[75px] xs:px-14 mxs:px-8 px-5'>
        ...
        <div className='text-white xs:w-[500px] mxs:w-full 3xs:w-full w-full relative mxs:top-[45px] top-[35px] text-left font-teko grid grid-cols-1 gap-12'>
          ...
          <div>
            ...
            <div style={{color:`${props.textclr}`}} className='md:w-[500px] mxs:w-[340px] 3xs:w-[250px] w-full text-sm font-arial font-medium'>{props.intro}</div>
