    ...
    <div className='lg:w-[1000px] container mx-auto md:px-0 px-5 lg:h-screen sm:h-[900px] h-screen flex items-center relative'>
      <div className='lg:w-9/12 md:w-10/12 text-white text-left z-20 absolute mt-24 xs:mx-0 mx-3'>
        ...
        <div className='md:text-[#B5B5B5] text-[#cca354] relative text-[28px] flex gap-5 mt-6'>
          <Link to={'https://github.com/marufibnehossain'} target={'_blank'}><FaGithub className='md:hover:text-[#cca354] transition-all duration-300' /></Link>
          <Link to={'https://www.linkedin.com/in/marufibnhossain/'} target={'_blank'}><FaLinkedin className='md:hover:text-[#cca354] transition-all duration-300' /></Link>
          <Link to={'https://www.researchgate.net/profile/Maruf'} target={'_blank'}><FaResearchgate className='md:hover:text-[#cca354] transition-all duration-300' /></Link>
          <Link to={'https://www.facebook.com/marufibnehossain'} target={'_blank'}><FaFacebook className='md:hover:text-[#cca354] transition-all duration-300' /></Link>
        </div>
      </div>
