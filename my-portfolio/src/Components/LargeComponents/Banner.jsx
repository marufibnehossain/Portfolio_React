...
import profile from '../../assets/images/profile/profile13.webp';
  ...
  return (
    <div className='lg:w-[1000px] container mx-auto md:px-0 px-5 lg:h-screen sm:h-[900px] h-screen flex items-center relative'>
      <div className='lg:w-9/12 md:w-10/12 text-white text-left z-20 absolute mt-24 xs:mx-0 mx-3'>
        ...
        <p className='sm:text-[#868686] text-white md:font-normal font-semibold font-nunito pt-8 text-lg xs:w-3/5'>I do Web Development and Machine Learning Research. Currently, I'm working as a Web Developer at <br /><Link to={'https://bemgroup.agency/'} target="_blank" className='text-[#C89B1E] font-bold'>BEM Group</Link>.</p>
