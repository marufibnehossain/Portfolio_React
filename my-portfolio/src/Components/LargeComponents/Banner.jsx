  ...
  return (
    <div className='lg:w-[1000px] container mx-auto lg:h-screen sm:h-[900px] h-screen flex items-center relative'>
      <div className='lg:w-9/12 md:w-10/12 text-white text-left z-20 absolute mt-24 xs:mx-0 mx-3'>
        ...
        <p className='text-[#868686] font-nunito pt-8 text-lg xs:w-3/5'>I do digital design, brand design, and art direction. Currently, I'm an Associate Creative Director at <br /><Link to={'https://www.techbucketbd.com/'} target="_blank" className='text-[#C89B1E]'>Tech Bucket</Link>.</p>
