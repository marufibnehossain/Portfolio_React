...
const CaseBanner = (props) => {
  return (
    <div style={{backgroundImage:`url(${props.bannerimage})`}} className='w-full bg-cover bg-top mx-auto px-0 lg:h-[764px] sm:h-[800px] h-[750px] flex items-center relative'>
