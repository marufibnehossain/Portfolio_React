          ...
          <React.Fragment key={index}>
            {index % 2 === 0 ? (
                <li>
                  ...
                  <div className="timeline-start timeline-box bg-white border-none sm:px-4 px-1 sm:py-2 py-1"><ExperienceCard exp={experience} /></div>
                ...
                <li>
                  ...
                  <div className="timeline-end timeline-box bg-white border-none sm:px-4 px-1 sm:py-2 py-1"><ExperienceCard exp={experience} /></div>
                  {index !== experiences.length-1 && (<hr className='bg-[#cca354]' />)}
                </li>
              )}
          </React.Fragment>
